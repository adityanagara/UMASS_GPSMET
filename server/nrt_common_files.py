...
#        dyna_file_name_nav=stn + doy + hour_alpha + '.' + str(time.gmtime().tm_year)[-2:] + 'n.Z'
        ...
        if dyna_file_name in file_list:
            os.chdir('/home/aditya/UMASS/DFWnet/net1/'+ str(time.gmtime().tm_year) +'/temp_rinex/obs')
...
def download_DFW_and_nav(doy,noaa_sites):
    ...
    os.chdir('/home/aditya/UMASS/DFWnet/net1/'+ str(time.gmtime().tm_year) + '/brdc')
...
def merge_rinex_files(doy,station_list):
    base_path = '/home/aditya/UMASS/DFWnet/net1/' + str(time.gmtime().tm_year) +'/temp_rinex/obs/'
    os.chdir(base_path)
...
def remove_brdc_comments(doy):
    brdc_file = '/home/aditya/UMASS/DFWnet/net1/' + str(time.gmtime().tm_year) +'/brdc/' + 'brdc' + doy + '0.' + str(time.gmtime().tm_year)[-2:] + 'n'
