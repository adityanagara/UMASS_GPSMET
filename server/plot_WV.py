...
def plot_WV(site):
    ...
    file_name='met_' + site + '.' + str(time.gmtime().tm_year)[-2:] + str(file_day).zfill(3)
    folder_name='/home/aditya/UMASS/DFWnet/net1/2015/WV'
    ...
    file_name_day=str(time.gmtime().tm_year) + str(time.gmtime().tm_mon).zfill(2) + str(time.gmtime().tm_mday).zfill(2)
    if time.gmtime().tm_hour == 0:
 ...
 #save_plot='/home/aditya/UMASS/20140917/TEST/2014/WV_Plots' + os.sep + 'cnvl' + file_name_day + '.png'
    save_plot=main_page + os.sep + str(file_day).zfill(3) + os.sep + site + file_name_day + str(time.gmtime().tm_hour).zfill(2) + '.png'
    print save_plot
