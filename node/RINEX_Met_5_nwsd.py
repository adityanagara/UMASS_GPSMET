...
def Check_Day_File(day):
    file_path = 'C:\Daily_Met_Data' + os.sep + str(time.gmtime().tm_year) + os.sep + 'nwsd' + str(day).zfill(3) + '0.' + str(time.gmtime().tm_year)[-2:] + 'm'
...
#        Open_Serial(ser_vaisala)
        ...
        file2 = 'C:\Daily_Met_Data' + os.sep + str(time.gmtime().tm_year) + os.sep + 'nwsd' + str(time.gmtime().tm_yday).zfill(3)  + '0.' + str(time.gmtime().tm_year)[-2:] + 'm'
