...
try:
    ...
    if time.gmtime().tm_hour == 0:
        output_file_1 = 'C:\Final_Data\RINEX_files' + os.sep + str(time.gmtime().tm_year) + os.sep + str(time.gmtime().tm_yday - 1).zfill(3)  + os.sep + stn + str(time.gmtime().tm_yday - 1).zfill(3) +'y' + '.' + str(time.gmtime().tm_year)[-2:] + 'o'
        output_file_1_nav = 'C:\Final_Data\RINEX_files' + os.sep + str(time.gmtime().tm_year) + os.sep + str(time.gmtime().tm_yday - 1).zfill(3) + os.sep + stn + str(time.gmtime().tm_yday - 1).zfill(3) +'y' + '.' + str(time.gmtime().tm_year)[-2:] + 'n'
